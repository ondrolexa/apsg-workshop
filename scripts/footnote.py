...
def test_is_python_35():
    ...
    if minor >= 5:
        print("Testing Python version-> python {}.{} OK".format(major, minor))
    else:
...
def test_numpy():
    ...
    print("Testing numpy...      -> numpy {} OK".format(np.__version__))
...
def test_pylab():
    ...
    if os.path.exists(testfilename):
        ...
        print("Testing matplotlib... -> pylab {} OK".format(pylab.mpl.__version__))
